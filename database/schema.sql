...
-- MCC licensing, audit and live client presence
...
CREATE INDEX IF NOT EXISTS idx_mcc_keys_ip ON mcc_keys(ip_address, expires_at DESC);
CREATE INDEX IF NOT EXISTS idx_mcc_activity_created ON mcc_activity(created_at DESC);
